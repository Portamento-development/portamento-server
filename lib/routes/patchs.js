...
router
  ...
  // I think these next three would also be better as a query option on general '/' route
  ...
  // should these last three routes be protected???
  // And enforce ownership for the logged in user?
